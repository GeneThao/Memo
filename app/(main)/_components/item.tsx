...
export const Item = ({
    ...
    const onArchive = (
        ...
        toast.promise(promise, {
            loading: "Taking out the trash...",
            success: "Yeah, it's trashed!",
            error: "Couldn't trash it."
        });
    };
    ...
    const onCreate = (
        ...
        toast.promise(promise, {
            ...
            success: "Awe yeah, time to go win!",
            error: "Failed to create a new note."
        });
    };
    
    return (
        <div onClick={onClick} role="button" style={{ paddingLeft: level ? `${(level * 12) + 12}px` : "12px" }} className={cn("group min-h-[27] text-sm py-1 pr-3 w-full hover:bg-primary/5 flex items-center text-muted-foreground font-medium", active && "bg-primary/5 text-primary")}>
            {!!id && (
